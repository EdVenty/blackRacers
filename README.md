...
---
## Repository overview
1. Photos of the team: located in the folder “Item number 1 - our photos”
- Photo (`` Ours photo.jpeg ``) - official team photo, and (`` ours funny photo.jpg ``) - funny
2. The photos of the robot are in the folder “Item number 2 - photographs of the robot from 6 sides”
...
4. Schematic diagrams: located in the folder “Item number 4 - schematic diagrams of electromechanical components.”
- The electrical circuit is presented in the file: `` Schematic_BlackRacer.png '', the circuit was designed in the EasyEda program, file: `` SCH_BlackRacer_team. Json``
- The kinetic diagram was compiled using GOST ’a, file:` `kinematic_scheme.jpg``
5. 3D models: they are in the folder “Item number 5 - 3d models used in the robot”
...
6. The "Program" folder contains all the code used on the robot and on the host computer
- `` wro.py '' - a program used in the simulator for the initial setting of algorithms
- `` wroracer '' - a program that runs on the robot and controls its actions
- `` regulators.py '' - robot motion regulator module
- `` RoboAPI.py '' - module for communication with the robot
- `` wroracer_last_win.py '' - the program that was used in regional competitions
- `` start_robot.py '' -file running on the host computer
- `` InetConnection.py '' - file for creating a server on the Raspberry Pi
7. Files in the main section:
- `` wroracer '' - a program that runs on the robot and controls its actions
- `` wroracer_last_win.py``-program that was used in regional competitions
- `` start_robot.py`` -file running on the host computer
- `` README.md`` file with user manual and overview of the repository
---
## Software setup
To configure the use of the BR-2G robot, you will need to install the following software:
1. All subsequent programs have been tested and configured for the Windows 10 operating system, and the manual also describes the installation for this system. If you have a different system installed, please use the Google search engine or its analogs to search for program installations on your own. If you do not have a graphical shell system (command line), then the installation of client programs may differ significantly from the manual. We strongly recommend using the latest builds of systems not lower than Windows 10, otherwise, you will be responsible for incorrect installation or inoperability of robot components.

2. Program for communication with devices via SSH and SFTP. For example, Bitvise SSH Client, which can be downloaded from the official website.
- To do this, go to the link https://www.bitvise.com/ssh-client-download and click the "Bitvise SSH Client Installer" button.
...
- Once opened, allow the app to make changes on the device. Click Yes.
- After permission, you will have two windows:

! [image005] (https://user-images.githubusercontent.com/80317959/129824695-265f6b38-87fe-4b9e-ade9-dca456e5ce2c.png)

In the small window, check the box “I agree to accept all the terms of the License Agreement” and click “Install”.
  
! [image007] (https://user-images.githubusercontent.com/80317959/129825008-e49fb9a8-92bf-45db-86e1-4af12a27a9df.png)
- If the installation is successful, you will see a window informing you about it. Click "OK"
...
- Follow the link https://github.com/EdVenty/blackRacers/archive/refs/heads/main.zip. This will open a browser window with the robot's repository.
...
Click on the "Download ZIP" button to download the archive repositoryI am.
- The repository will be downloaded to an archive in ".zip" format.
...
- Copy the single root folder and extract to any other folder on your drive.
...
- The repository has been downloaded to your computer.
4. A program for communicating with the robot using the UART protocol, for loading the firmware into the PyBoard microcontroller, for example, "PuTTY".
- Follow the link https://www.chiark.greenend.org.uk/~sgtatham/putty/latest.html. This will open a download window for the PuTTY installer. Find the following area (labels may vary):
...
- Click the Next button and you will see the following window:
...
- Click "Install". The application will ask for administrator rights, allow them to be granted by clicking the "Yes" button. Further
...
6. Installation of the "Python" runtime.
- Go to https://www.python.org/downloads/windows/ and find the item "Python 3.7.0 - June 27, 2018".
...
- You will see the installer window. Click the checkmark to the left of the Add Python 3.7 to PATH box.

! [image045] (https://user-images.githubusercontent.com/80317959/130032849-ac41a10a-6b06-4485-9e5e-d3d9674d8831.png)
- Click the "Install Now" button. Wait for installation.

! [image048] (https://user-images.githubusercontent.com/80317959/130032917-3e350ddb-30ba-40ab-9966-665bd0496228.png)
- After successful installation, you will see a window informing about it. Click Close.

! [image050] (https://user-images.githubusercontent.com/80317959/130032976-06563953-6dff-4e86-8617-baa6b6f3ac91.png)
---
## Downloading software to the robot.
Next, you need to download the necessary files and programs to the robot. To download to the robot, you will need the programs, the installation of which is shown above, as well as:
- USB-A (male) to micro-USB (male) wire (at least 15 centimeters).
- Ethernet cable
- SD card for at least 8 gigabytes of memory.
- Computer with ethernet port.

Installation progress:
1. Install Raspbian OS Lite to SD card.
- Insert the SD card into your computer.
- Open Raspberry PI Imager. You should see the following window:

! [image052] (https://user-images.githubusercontent.com/80317959/130036760-86111ffc-cba3-455e-b008-d119deb70e67.png)
- Press the "CHOOSE OS" button. You will see a window for selecting the Raspberry PI operating system.

! [image054] (https://user-images.githubusercontent.com/80317959/130036829-8c43f8da-4fbf-4732-8686-6d3b5e17c9b6.png)
- Click "Raspberry PI OS (other)". You will be presented with the following:

! [image056] (https://user-images.githubusercontent.com/80317959/130036902-13bc52c9-aaa3-4b28-a84e-234d4cc7ec1c.png)
- Select "Raspberry PI OS Lite (32-bit)". The window will be reset to the initial one, and the operating system will be selected.
...
- After selection, the window will be reset. To write the operating system to the "WRITE" flash drive.

! [image062] (https://user-images.githubusercontent.com/80317959/130037245-2d7d4892-ad2d-4ba9-b9b7-3a805c124758.png)
- After recording and verifying the files, you can take out the SD card. Until this time, the card cannot be removed!
2. Activating SSH protocol on Raspberry PI.
- Insert the SD card into your computer.
...
- In the column "Devices and disks" you will see a disk named "boot". Open it up.

! [image067] (https://user-images.githubusercontent.com/80317959/130037922-34aafe94-851a-45a9-a305-ce9435dfa247.png)
Here are the important files for loading the Raspberry PI operating system.
- Right click on the white area and click New, select Text Document.
...
The content of the file can also be left blank.

! [image071] (https://user-images.githubusercontent.com/80317959/130038044-5f948d15-eef6-4307-a058-a349b88d23d1.png)

If your extensions are not displayed (for example, the file "config.txt" does not have the extension ".txt", then use the following steps:
...
- You should open the following panel:

! [image074] (https://user-images.githubusercontent.com/80317959/130038473-b3867d52-a021-40e1-8a2d-0e764ce050e7.png)
- If you do not have a check mark in the "File name extensions" box, then check it.

- Remove SD card from computer and insert into Raspberry PI. Power on the Raspberry PI.
The system initialization process will begin, at this time, the yellow LED will blink actively.

- Wait 5-10 minutes for the system to be fully prepared. Subsequent launches will be much faster.
After this period, you can proceed to the next steps.
3. Configuring the Raspberry PI camera.
- Connect the Raspberry PI to your computer using an Ethernet cable.
- Start the "Bitvise SSH Client" program. The following window will open:
...
- In the "Authentication" section in the "Login" field, enter the word "pi" login.
In the "Initial method" field, select the "password" value.

! [image080] (https://user-images.githubusercontent.com/80317959/130159366-00e656bf-3bf0-44eb-8c2f-9e67c5411c45.png)
- Click the checkbox next to "Store enctypted password in profile". The "Password" field will no longer be grayed out.
...
- At the bottom of the window, click the "Login" button. Wait until Bitvise SSH Client connects to Raspberry PI.

- If, after the connection expires, the following error appears in the logs
! [image086] (https://user-images.githubusercontent.com/80317959/130159719-affa7e3d-5172-47dc-bc34-515d0172f8ae.png) then change the Host field to raspberrypi.
...
- The panel will update on the left. Click on the next button! [Image090] (https://user-images.githubusercontent.com/80317959/130159918-f652285f-d1b9-4bfc-b56b-ca9628af0626.png).
This will open a Raspberry PI remote terminal window.
! [image092] (https: //user-images.githubusercontent.com/80317959/130159980-04593e9d-f982-4c3a-8416-b69aa03b1b88.png)
Here you can write commands for Raspberry PI.

- Connect your computer to the Internet, if you haven't already.
- Write the following commands in the terminal:

`` sudo apt upgrade``

`` sudo apt full-upgrade``
- After that, the Raspberry PI will be updated. It may take time.
- Write the command in the terminal:

`` sudo raspi-config``
- This will open the Raspberry settings window.
- Use the up and down arrows on your keyboard to move the red cursor to the "Interfacing Options" element.

! [image094] (https://user-images.githubusercontent.com/80317959/130160144-ac2261b7-9e09-404c-a0f0-0791a41ab375.png)
- Press "Enter". This will open the Raspberry PI interface settings.
...
- Press "Enter". Thus, you have turned on the camera on the Raspberry PI.
- Press Esc until the window returns to the original terminal.
- Enter the command into the terminal:

`` sudo reboot``
- The Raspberry PI will reboot and the camera will be able to work.

4. Server setup on Raspberry PI
- Repeat steps a-h of point 3.
...
This will open a window for transferring files to the Raspberry PI.
- In the "Remote files" part of the window, right-click on the white area and select "Create folder". Enter the folder name "robot".

! [image102] (https://user-images.githubusercontent.com/80317959/130160445-cbcb99e0-de0d-4947-a3c5-3d8bbf4d8f48.png)
- Open the "robot" folder by double-clicking. It must be empty.
- Open the folder of the repository downloaded from GitHub. Highlight the 4 files shown:

! [image104] (https://user-images.githubusercontent.com/80317959/130160518-569ca432-42d9-4b6e-ae38-e81df7fdddcf.png)
And drag it into the Bitvise SFTP window, into the "Remote files" zone. They should be copied to the Raspberry PI and displayed in the "robot" folder.
- Open a terminal in the main window of BItvise SSH Client.
- Write the command:
...
- Before the line "_IP = $ (hostname -I) || true "add the following line (you can move the cursor using the arrows on the keyboard):
...
- Press on the keyboard "x", then "y". The file will be saved.
- Reboot the Raspberry PI.
5. PyBoard Firmware
- Connect PyBoard to your computer with a micro-USB cable.
- Open Windows Explorer
- In the field "Devices and disks" open the disk with the name "PYBFLASH".
...
- Copy them to the root of the PYBFLASH disk.

! [image113] (https://user-images.githubusercontent.com/80317959/130160747-05ae1c7c-5b5f-4c59-951e-69a8deedf690.png)
- On the PyBoard, the red LED will light up at this moment. Wait for it to disconnect and disconnect the USB cable.
In case of early removal of the USB cable, all information from PyBoard will be erased!
- PyBoard flashed successfully.
---
## Communication with the robot and launching programs
The Robot Starter program written by Yuri Glamazdin is used to communicate with the robot. You can find its starter file in the GitHub repository folder.
Robot connection:
1. Connect to the wifi network of the robot (name may vary).

! [image115] (https://user-images.githubusercontent.com/80317959/130160857-b1fe5578-52d9-467c-9929-11ac50dff20d.png)

2. Open the GitHub repository folder. Run the file named "start_robot.py".
...
- Start - load and run the already selected program file.
...
- When pressed, the robot selection window appears:
...
- To select a robot, click on its IP. Byafter connecting, the following text will be displayed in the console
...
- Console. Messages from the robot. All errors during program execution and text output (print) are displayed here.
3. Starting the program:
- Select the robot as shown in paragraph 2.f.
- Press the "Load Start" button shown in point 2.a.
- In the window that opens, find the GitHub repository folder, select the "wroracer_last_win.py" file. Click "Open".

! [image124] (https://user-images.githubusercontent.com/80317959/130161366-c95fb988-52e0-43c4-be1e-80dfca4feae8.png)
- The program is running. Press the button to start riding.
---
