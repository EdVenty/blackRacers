...
if flag_qualification:
    ...
    global_speed += 68.6
    pause_finish = 0.28
    porog_black_line_plus+=40  # по часовой стрелке 40
    porog_black_line_minus+=40   # против 40
...
pause_povorot = 0.45 #0.45 SEC 0.45 sec the qula
